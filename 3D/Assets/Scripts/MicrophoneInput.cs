...
public class MicrophoneRecorder : MonoBehaviour
{
    ...
    public TextMeshProUGUI userHoldingItem;

    private Backend _backend;
    private CharacterAnimatorControl character;
    ...
    void Start()
    {
        ...
        Backend.Init(audioSource, select.selected_assistant_id,select.fileList);
        ...
        character = FindObjectOfType<CharacterAnimatorControl>();
    }
    ...
    {
        AudioClip clip= await Backend.Run(audio, userHoldingItem.text);

        //播放
        audioSource.pitch= 0.75F;
        audioSource.clip=clip;
        character.StartTalking(audioSource);
